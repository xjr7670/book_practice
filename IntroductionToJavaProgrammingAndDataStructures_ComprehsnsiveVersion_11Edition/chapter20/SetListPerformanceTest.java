...
public class SetListPerformanceTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Menber test time for hash set is " + getTestTime(set1) + " milliseconds");
        ...
        System.out.println("Menber test time for linked set is " + getTestTime(set2) + " milliseconds");
        System.out.println("Remove element time for linked set is " + getRemoveTime(set2) + " milliseconds");

        // Create a tree hash set, and test its performance
        Collection<Integer> set3 = new TreeSet<>(list);
        System.out.println("Menber test time for tree set is " + getTestTime(set3) + " milliseconds");
        ...
        System.out.println("Menber test time for array list is " + getTestTime(list1) + " milliseconds");
        ...
        System.out.println("Menber test time for linked list is " + getTestTime(list2) + " milliseconds");
