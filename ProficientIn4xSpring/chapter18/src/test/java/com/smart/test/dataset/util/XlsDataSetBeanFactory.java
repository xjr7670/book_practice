...
public class XlsDataSetBeanFactory {
    ...
    public static List<Map<String, Object>> createProps(Class testClass, String file, String tableName) throws IOException, DataSetException {
        ...
        for (int i = 0; i < table.getRowCount(); i++ ) {
            ...
            for (Column c: columns) {
                ...
                String progName = underLineToCamel(c.getColumnName());
                props.put(progName, value);
            }
            propsList.add(props);
        }
        return  propsList;
    ...
    public static ConvertUtilsBean createConvertUtils() {
