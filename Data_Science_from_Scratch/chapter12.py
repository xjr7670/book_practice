...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct  6 16:13:59 2017
...
def plot_data():
    """plot the data of cities, chapter12.2"""
    ...
    plt.title("Most use language")
    plt.show()
    
    
def forecast_lang():
    """forecast the perfer language in each city"""
